...
export const AwardBadge = ({
  ...
  return (
    <a
      ...
      className={className || "block w-[180px] sm:w-[260px] h-auto cursor-pointer"}
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-full h-auto">
          ...
          <rect width="260" height="54" rx="10" fill={bgColor || backgroundColor[(place || 2) - 1] || backgroundColor[1]} />
          ...
          <g style={{ mixBlendMode: "overlay" }} mask="url(#badgeMask)">
            {overlayColors.map((fill, i) => (
              <g key={i} style={{
                ...
                <polygon points="0,0 260,54 260,0 0,54" fill={fill} filter="url(#blur1)" opacity="0.5" />
              </g>
            ))}
          </g>
        </svg>
